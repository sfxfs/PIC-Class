#ifndef	_HTC_H_
#warning Header file pic16f1934.h included directly. Use #include <htc.h> instead.
#endif
...
#ifndef __PIC16F1934_H
#define __PIC16F1934_H
...
// Internal Oscillator Frequency Select bits
volatile bit IRFC3               @ ((unsigned)&OSCCON*8)+6;
...
volatile bit D1NSS               @ ((unsigned)&DACCON0*8)+0;
// DAC1 Positive Source Select bits
volatile bit D1PSS0              @ ((unsigned)&DACCON0*8)+2;
// DAC1 Positive Source Select bits
volatile bit D1PSS1              @ ((unsigned)&DACCON0*8)+3;
// DAC1 Voltage Output Enable bit
volatile bit DAC1OE              @ ((unsigned)&DACCON0*8)+5;
// DAC 1 Low Power Voltage State Select bit
volatile bit D1LPS               @ ((unsigned)&DACCON0*8)+6;
// DAC 1 Enable bit
volatile bit D1EN                @ ((unsigned)&DACCON0*8)+7;
#ifndef _LIB_BUILD
union {
    struct {
        volatile unsigned D1NSS               : 1;
        volatile unsigned                     : 1;
        volatile unsigned D1PSS0              : 1;
        volatile unsigned D1PSS1              : 1;
        volatile unsigned                     : 1;
        volatile unsigned DAC1OE              : 1;
        volatile unsigned D1LPS               : 1;
        volatile unsigned D1EN                : 1;
    };
    struct {
        volatile unsigned                     : 2;
        volatile unsigned D1PSS               : 2;
    };
} DACCON0bits @ 0x118;
#endif
...
volatile bit DAC1R0              @ ((unsigned)&DACCON1*8)+0;
// DAC1 Voltage Output Select bits
volatile bit DAC1R1              @ ((unsigned)&DACCON1*8)+1;
// DAC1 Voltage Output Select bits
volatile bit DAC1R2              @ ((unsigned)&DACCON1*8)+2;
// DAC1 Voltage Output Select bits
volatile bit DAC1R3              @ ((unsigned)&DACCON1*8)+3;
// DAC1 Voltage Output Select bits
volatile bit DAC1R4              @ ((unsigned)&DACCON1*8)+4;
#ifndef _LIB_BUILD
union {
    struct {
        volatile unsigned DAC1R0              : 1;
        volatile unsigned DAC1R1              : 1;
        volatile unsigned DAC1R2              : 1;
        volatile unsigned DAC1R3              : 1;
        volatile unsigned DAC1R4              : 1;
        volatile unsigned                     : 1;
    };
    struct {
        volatile unsigned DAC1R               : 5;
    };
} DACCON1bits @ 0x119;
#endif
...
volatile unsigned char           BAUDCTL             @ 0x19F;
// bit and bitfield definitions
...
// bit and bitfield definitions
volatile bit PSS1BD0             @ ((unsigned)&ECCP1AS*8)+0;
volatile bit PSS1BD1             @ ((unsigned)&ECCP1AS*8)+1;
volatile bit PSS1AC0             @ ((unsigned)&ECCP1AS*8)+2;
volatile bit PSS1AC1             @ ((unsigned)&ECCP1AS*8)+3;
volatile bit CCP1AS0             @ ((unsigned)&ECCP1AS*8)+4;
volatile bit CCP1AS1             @ ((unsigned)&ECCP1AS*8)+5;
volatile bit CCP1AS2             @ ((unsigned)&ECCP1AS*8)+6;
volatile bit CCP1ASE             @ ((unsigned)&ECCP1AS*8)+7;
#ifndef _LIB_BUILD
union {
    struct {
...
// bit and bitfield definitions
volatile bit PSS2BD0             @ ((unsigned)&ECCP2AS*8)+0;
volatile bit PSS2BD1             @ ((unsigned)&ECCP2AS*8)+1;
volatile bit PSS2AC0             @ ((unsigned)&ECCP2AS*8)+2;
volatile bit PSS2AC1             @ ((unsigned)&ECCP2AS*8)+3;
volatile bit CCP2AS0             @ ((unsigned)&ECCP2AS*8)+4;
volatile bit CCP2AS1             @ ((unsigned)&ECCP2AS*8)+5;
volatile bit CCP2AS2             @ ((unsigned)&ECCP2AS*8)+6;
volatile bit CCP2ASE             @ ((unsigned)&ECCP2AS*8)+7;
#ifndef _LIB_BUILD
union {
    struct {
...
// bit and bitfield definitions
volatile bit PSS3BD0             @ ((unsigned)&ECCP3AS*8)+0;
volatile bit PSS3BD1             @ ((unsigned)&ECCP3AS*8)+1;
volatile bit PSS3AC0             @ ((unsigned)&ECCP3AS*8)+2;
volatile bit PSS3AC1             @ ((unsigned)&ECCP3AS*8)+3;
volatile bit CCP3AS0             @ ((unsigned)&ECCP3AS*8)+4;
volatile bit CCP3AS1             @ ((unsigned)&ECCP3AS*8)+5;
volatile bit CCP3AS2             @ ((unsigned)&ECCP3AS*8)+6;
volatile bit CCP3ASE             @ ((unsigned)&ECCP3AS*8)+7;
#ifndef _LIB_BUILD
union {
    struct {
...
union {
    struct {
        volatile unsigned LMUX0               : 1;
        volatile unsigned LMUX1               : 1;
        volatile unsigned CS0                 : 1;
        volatile unsigned CS1                 : 1;
        volatile unsigned                     : 1;
        volatile unsigned WERR                : 1;
        volatile unsigned SLPEN               : 1;
        volatile unsigned LCDEN               : 1;
    };
    struct {
        volatile unsigned LMUX                : 2;
...
union {
    struct {
        volatile unsigned LP0                 : 1;
        volatile unsigned LP1                 : 1;
        volatile unsigned LP2                 : 1;
        volatile unsigned LP3                 : 1;
        volatile unsigned WA                  : 1;
        volatile unsigned LCDA                : 1;
        volatile unsigned BIASMD              : 1;
        volatile unsigned WFT                 : 1;
    };
    struct {
        volatile unsigned LP                  : 4;
    };
} LCDPSbits @ 0x792;
#endif
...
union {
    struct {
        volatile unsigned                     : 1;
        volatile unsigned VLCD1PE             : 1;
        volatile unsigned VLCD2PE             : 1;
        volatile unsigned VLCD3PE             : 1;
        volatile unsigned                     : 1;
        volatile unsigned LCDIRI              : 1;
        volatile unsigned LCDIRS              : 1;
        volatile unsigned LCDIRE              : 1;
    };
} LCDREFbits @ 0x793;
#endif
...
union {
    struct {
        volatile unsigned LCDCST0             : 1;
        volatile unsigned LCDCST1             : 1;
        volatile unsigned LCDCST2             : 1;
    };
    struct {
        volatile unsigned LCDCST              : 3;
    };
} LCDCSTbits @ 0x794;
#endif
...
union {
    struct {
        volatile unsigned LRLAT0              : 1;
        volatile unsigned LRLAT1              : 1;
        volatile unsigned LRLAT2              : 1;
        volatile unsigned                     : 1;
        volatile unsigned LRLBP0              : 1;
        volatile unsigned LRLBP1              : 1;
        volatile unsigned LRLAP0              : 1;
        volatile unsigned LRLAP1              : 1;
    };
    struct {
        volatile unsigned LRLAT               : 3;
        volatile unsigned                     : 1;
        volatile unsigned LRLBP               : 2;
        volatile unsigned LRLAP               : 2;
    };
} LCDRLbits @ 0x795;
#endif
...
union {
    struct {
        volatile unsigned SEG0                : 1;
        volatile unsigned SEG1                : 1;
        volatile unsigned SEG2                : 1;
        volatile unsigned SEG3                : 1;
        volatile unsigned SEG4                : 1;
        volatile unsigned SEG5                : 1;
        volatile unsigned SEG6                : 1;
        volatile unsigned SEG7                : 1;
    };
} LCDSE0bits @ 0x798;
#endif
...
union {
    struct {
        volatile unsigned SEG8                : 1;
        volatile unsigned SEG9                : 1;
        volatile unsigned SEG10               : 1;
        volatile unsigned SEG11               : 1;
        volatile unsigned SEG12               : 1;
        volatile unsigned SEG13               : 1;
        volatile unsigned SEG14               : 1;
        volatile unsigned SEG15               : 1;
    };
} LCDSE1bits @ 0x799;
#endif
...
union {
    struct {
        volatile unsigned SEG16               : 1;
        volatile unsigned SEG17               : 1;
        volatile unsigned SEG18               : 1;
        volatile unsigned SEG19               : 1;
        volatile unsigned SEG20               : 1;
        volatile unsigned SEG21               : 1;
        volatile unsigned SEG22               : 1;
        volatile unsigned SEG23               : 1;
    };
} LCDSE2bits @ 0x79A;
#endif
...
union {
    struct {
        volatile unsigned SEG0COM0            : 1;
        volatile unsigned SEG1COM0            : 1;
        volatile unsigned SEG2COM0            : 1;
        volatile unsigned SEG3COM0            : 1;
        volatile unsigned SEG4COM0            : 1;
        volatile unsigned SEG5COM0            : 1;
        volatile unsigned SEG6COM0            : 1;
        volatile unsigned SEG7COM0            : 1;
    };
} LCDDATA0bits @ 0x7A0;
#endif
...
union {
    struct {
        volatile unsigned SEG8COM0            : 1;
        volatile unsigned SEG9COM0            : 1;
        volatile unsigned SEG10COM0           : 1;
        volatile unsigned SEG11COM0           : 1;
        volatile unsigned SEG12COM0           : 1;
        volatile unsigned SEG13COM0           : 1;
        volatile unsigned SEG14COM0           : 1;
        volatile unsigned SEG15COM0           : 1;
    };
} LCDDATA1bits @ 0x7A1;
#endif
...
union {
    struct {
        volatile unsigned SEG16COM0           : 1;
        volatile unsigned SEG17COM0           : 1;
        volatile unsigned SEG18COM0           : 1;
        volatile unsigned SEG19COM0           : 1;
        volatile unsigned SEG20COM0           : 1;
        volatile unsigned SEG21COM0           : 1;
        volatile unsigned SEG22COM0           : 1;
        volatile unsigned SEG23COM0           : 1;
    };
} LCDDATA2bits @ 0x7A2;
#endif
...
union {
    struct {
        volatile unsigned SEG0COM1            : 1;
        volatile unsigned SEG1COM1            : 1;
        volatile unsigned SEG2COM1            : 1;
        volatile unsigned SEG3COM1            : 1;
        volatile unsigned SEG4COM1            : 1;
        volatile unsigned SEG5COM1            : 1;
        volatile unsigned SEG6COM1            : 1;
        volatile unsigned SEG7COM1            : 1;
    };
} LCDDATA3bits @ 0x7A3;
#endif
...
union {
    struct {
        volatile unsigned SEG8COM1            : 1;
        volatile unsigned SEG9COM1            : 1;
        volatile unsigned SEG10COM1           : 1;
        volatile unsigned SEG11COM1           : 1;
        volatile unsigned SEG12COM1           : 1;
        volatile unsigned SEG13COM1           : 1;
        volatile unsigned SEG14COM1           : 1;
        volatile unsigned SEG15COM1           : 1;
    };
} LCDDATA4bits @ 0x7A4;
#endif
...
union {
    struct {
        volatile unsigned SEG16COM1           : 1;
        volatile unsigned SEG17COM1           : 1;
        volatile unsigned SEG18COM1           : 1;
        volatile unsigned SEG19COM1           : 1;
        volatile unsigned SEG20COM1           : 1;
        volatile unsigned SEG21COM1           : 1;
        volatile unsigned SEG22COM1           : 1;
        volatile unsigned SEG23COM1           : 1;
    };
} LCDDATA5bits @ 0x7A5;
#endif
...
union {
    struct {
        volatile unsigned SEG0COM2            : 1;
        volatile unsigned SEG1COM2            : 1;
        volatile unsigned SEG2COM2            : 1;
        volatile unsigned SEG3COM2            : 1;
        volatile unsigned SEG4COM2            : 1;
        volatile unsigned SEG5COM2            : 1;
        volatile unsigned SEG6COM2            : 1;
        volatile unsigned SEG7COM2            : 1;
    };
} LCDDATA6bits @ 0x7A6;
#endif
...
union {
    struct {
        volatile unsigned SEG8COM2            : 1;
        volatile unsigned SEG9COM2            : 1;
        volatile unsigned SEG10COM2           : 1;
        volatile unsigned SEG11COM2           : 1;
        volatile unsigned SEG12COM2           : 1;
        volatile unsigned SEG13COM2           : 1;
        volatile unsigned SEG14COM2           : 1;
        volatile unsigned SEG15COM2           : 1;
    };
} LCDDATA7bits @ 0x7A7;
#endif
...
union {
    struct {
        volatile unsigned SEG16COM2           : 1;
        volatile unsigned SEG17COM2           : 1;
        volatile unsigned SEG18COM2           : 1;
        volatile unsigned SEG19COM2           : 1;
        volatile unsigned SEG20COM2           : 1;
        volatile unsigned SEG21COM2           : 1;
        volatile unsigned SEG22COM2           : 1;
        volatile unsigned SEG23COM2           : 1;
    };
} LCDDATA8bits @ 0x7A8;
#endif
...
union {
    struct {
        volatile unsigned SEG0COM3            : 1;
        volatile unsigned SEG1COM3            : 1;
        volatile unsigned SEG2COM3            : 1;
        volatile unsigned SEG3COM3            : 1;
        volatile unsigned SEG4COM3            : 1;
        volatile unsigned SEG5COM3            : 1;
        volatile unsigned SEG6COM3            : 1;
        volatile unsigned SEG7COM3            : 1;
    };
} LCDDATA9bits @ 0x7A9;
#endif
...
union {
    struct {
        volatile unsigned SEG8COM3            : 1;
        volatile unsigned SEG9COM3            : 1;
        volatile unsigned SEG10COM3           : 1;
        volatile unsigned SEG11COM3           : 1;
        volatile unsigned SEG12COM3           : 1;
        volatile unsigned SEG13COM3           : 1;
        volatile unsigned SEG14COM3           : 1;
        volatile unsigned SEG15COM3           : 1;
    };
} LCDDATA10bits @ 0x7AA;
#endif
...
union {
    struct {
        volatile unsigned SEG16COM3           : 1;
        volatile unsigned SEG17COM3           : 1;
        volatile unsigned SEG18COM3           : 1;
        volatile unsigned SEG19COM3           : 1;
        volatile unsigned SEG20COM3           : 1;
        volatile unsigned SEG21COM3           : 1;
        volatile unsigned SEG22COM3           : 1;
        volatile unsigned SEG23COM3           : 1;
    };
} LCDDATA11bits @ 0x7AB;
#endif
