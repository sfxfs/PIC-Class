...
/*Power out reset timer*/
#define	PWRTEN		0x3FF7		/* powerup timer ensable */
#define	PWRTDIS		0x3FFF		/* powerup timer disable */
...
/* code protection */
#define UNPROTECT	0x3FFF		/* all memory code is unprotected */
